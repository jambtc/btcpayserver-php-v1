...
interface InvoiceInterface
{
     ...
     * payments and over payments are handled by btcpay.com by either refunding the
    ...
    /**
     * Questa funzione serve per recuperare le informazioni sulle transazioni
     * by Sergio Casizzone 17.10.2019
     * @return array
     */
    ...
    /**
     * default value: set in your https://btcpay.com/order­settings, the default value set in
    ...
    /**
     * Btcpay.com will send an email to this email address when the invoice status
     * changes.
     *
     * @return string
     */
     ...
     * Btcpay.com will send a POST request with a JSON encoding of the invoice to
    ...
    /**
     * The unique id of the invoice assigned by btcpay.com
     *
     * @return string
     */
