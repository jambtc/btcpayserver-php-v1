...
class Payout implements PayoutInterface
{
    ...
    /**
     * Set the batch ID as assigned from btcpay.
     *
     * @param $id
     * @return $this
     */
    ...
    /**
     * Set Account Id - Btcpays account ID for the payout.
     *
     * @param $id
     * @return $this
     */
    ...
    /**
     * Set the Bitcoin amount for this payout, once set by Btcpay.
     * @param $amount
     * @return $this
     */
    ...
    /**
     * Set Response Token - returned by Btcpay when payout request is created
     *
     * @param $responseToken
     * @return $this
     */
