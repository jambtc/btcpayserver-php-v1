...
interface PayoutInterface
{
    ...
    /**
     * Once Btcpay receives a corresponding ACH transfer from the payroll provider,
    ...
    /**
     * The batch ID of the payout assigned by Btcpay.com
     *
     * @return string
     */
    ...
    /**
     * Return the account parameter given by Btcpay.
     *
     * @return string
     */
     ...
     *
     * @return \Btcpay\CurrencyInterface
     */
     ...
     * Btcpay.com will send a POST request with a JSON encoding of the batch to this
