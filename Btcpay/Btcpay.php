...
use Btcpay\DependencyInjection\BtcpayExtension;
use Btcpay\DependencyInjection\Loader\ArrayLoader;
...
class Btcpay
{
     ...
     * see \Btcpay\Config\Configuration class
     *
    ...
    {
        return array(
            'btcpay.root_dir' => realpath(__DIR__.'/..'),
        );
    }
